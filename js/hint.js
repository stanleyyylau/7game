...
var HintType = {
  None: '无',
  RowsMustBeUnique: '两行不能完全一样.',
  ColsMustBeUnique: '两列不能完全一样.',
  RowMustBeBalanced: '每行的颜色数量应该相等.',
  ColMustBeBalanced: '每列的颜色数量应该相等.',
  MaxTwoRed: '三个红字格子不能挨边靠着.',
  MaxTwoBlue: '三个蓝色格子不能挨边靠着.',
